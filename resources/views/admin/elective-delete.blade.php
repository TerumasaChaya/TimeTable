    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        ...
        <ol class="breadcrumb page-breadcrumb">
            <li>
                ...
                <i class="fa fa-angle-right"></i>&nbsp;&nbsp;
                <a href="/admin/elective/authorized/{{$subId}}">認証済み生徒一覧</a>&nbsp;&nbsp;
                <i class="fa fa-angle-right"></i>&nbsp;&nbsp;
                <a href="#">認証取消生徒一覧</a>&nbsp;&nbsp;
            </li>
        </ol>
                    ...
                    <div class="row">
                        <div class="panel panel-orange">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="/admin/elective/delete" method="post">
                                    ...
                                    <div></br>
                                    <input type="submit" class="btn btn-orange" value="取消">
                                    <a href="/admin/elective/authorized/{{$subId}}"><input type="button" class="btn btn-orange" value="キャンセル"></a></div>
                                </form>
                            </div>
                        </div>
                    </div>
